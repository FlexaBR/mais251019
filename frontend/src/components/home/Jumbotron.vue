<template>
  <v-sheet
    :height="$vuetify.breakpoint.smAndUp ? '62vh' : '78vh'"
    color="white"
    tile
  >
    <v-img
      ...
      src="@/assets/home/index_1.jpg"
      gradient="to top, rgba(0, 0, 0, .0), rgba(0, 0, 0, .4)"
      height="100%"
    >
      <v-container
        ...
        <v-slide-x-transition appear>
          ...
          >
            <h1
              ...
              class="mb-2"
            >
              Bom é Comprar Certo e Vender Bem
            </h1>
            <div :class="$vuetify.breakpoint.smAndUp ? 'title font-weight-light' : 'title font-weight-thin'">
              Mais Representações a sua assessoria no Rio Grande do Sul para as compras de sua loja.
            </div>
          </v-col>
